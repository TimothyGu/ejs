...
var compile = exports.compile = function(str, opts){
  var opts = opts || {}
    , escape = opts.escape || utils.escape
  ...
  try {
    var fn = new Function('locals, escape, include, rethrow', str);
  }
  catch(e) {
...
exports.render = function(str, locals, opts){
  var fn
    , locals = locals || {}
    , opts = opts || {};
  ...
  if (opts.cache) {
    if (opts.filename) {
      fn = cache[opts.filename] || (cache[opts.filename] = compile(str, opts));
    } else {
